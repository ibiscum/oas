...
// checks if the ObjectWithArrayArrayInnerInputsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ObjectWithArrayArrayInnerInputsInner{}

// ObjectWithArrayArrayInnerInputsInner struct for ObjectWithArrayArrayInnerInputsInner
type ObjectWithArrayArrayInnerInputsInner struct {
	Input1 *string `json:"input 1,omitempty"`
	Input2 *string `json:"input 2,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _ObjectWithArrayArrayInnerInputsInner ObjectWithArrayArrayInnerInputsInner
...
func NewObjectWithArrayArrayInnerInputsInner() *ObjectWithArrayArrayInnerInputsInner {
	this := ObjectWithArrayArrayInnerInputsInner{}
	return &this
}
...
func (o ObjectWithArrayArrayInnerInputsInner) MarshalJSON() ([]byte, error) {
...
func (o ObjectWithArrayArrayInnerInputsInner) ToMap() (map[string]interface{}, error) {
...
func (o *ObjectWithArrayArrayInnerInputsInner) UnmarshalJSON(data []byte) (err error) {
	varObjectWithArrayArrayInnerInputsInner := _ObjectWithArrayArrayInnerInputsInner{}

	err = json.Unmarshal(data, &varObjectWithArrayArrayInnerInputsInner)

	if err != nil {
		return err
	}

	*o = ObjectWithArrayArrayInnerInputsInner(varObjectWithArrayArrayInnerInputsInner)
...
type NullableObjectWithArrayArrayInnerInputsInner struct {
	value *ObjectWithArrayArrayInnerInputsInner
	isSet bool
}

func (v NullableObjectWithArrayArrayInnerInputsInner) Get() *ObjectWithArrayArrayInnerInputsInner {
	return v.value
}

func (v *NullableObjectWithArrayArrayInnerInputsInner) Set(val *ObjectWithArrayArrayInnerInputsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableObjectWithArrayArrayInnerInputsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableObjectWithArrayArrayInnerInputsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableObjectWithArrayArrayInnerInputsInner(val *ObjectWithArrayArrayInnerInputsInner) *NullableObjectWithArrayArrayInnerInputsInner {
	return &NullableObjectWithArrayArrayInnerInputsInner{value: val, isSet: true}
}

func (v NullableObjectWithArrayArrayInnerInputsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableObjectWithArrayArrayInnerInputsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
